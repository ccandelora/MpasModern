...
const searchQueries = [
  { 
    query: "professional police officer desk paperwork", 
    filename: "process-review.jpg",
    orientation: "landscape",
    size: "large"
  },
  { 
    query: "police officers meeting conference room", 
    filename: "process-planning.jpg",
    orientation: "landscape",
    size: "large"
  },
  { 
    query: "police training classroom professional", 
    filename: "process-development.jpg",
    orientation: "landscape",
    size: "large"
  },
  { 
    query: "police officers training seminar", 
    filename: "process-training.jpg",
    orientation: "landscape",
    size: "large"
  }
];
...
async function main() {
  ...
  const imagesDir = path.join(process.cwd(), 'client', 'src', 'assets', 'images');
